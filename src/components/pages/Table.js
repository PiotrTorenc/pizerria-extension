...
import InputAmount from '../funcionality/InputAmount.js';
import InputPeople from '../funcionality/InputPeople.js';
import InputAvailability from '../funcionality/InputAvailability.js';
    ...
    <div>
      ...
      <Form onSubmit={handleUpdateTable}>
        ...
        <InputPeople
          ...
          setTablePeopleAmount={setTablePeopleAmount}
          maxPeopleAmount={maxPeopleAmount}
          setMaxPeopleAmount={setMaxPeopleAmount}
        />
        <InputAmount setTableBill={setTableBill} bill={bill} status={status} />
